...
(function(){
    ...
    var DayBlockDirective = function () {
        return {
            template : 
            '<div class="day-bloc">'+
            '<div class="weekday">{{controller.date | luifMoment: \'dddd\'}}'+
            '</div>'+
            '<div class="day">{{controller.date | luifMoment:\'DD\'}}</div>'+
            '<div class="month">{{controller.date | luifMoment: \'MMM\' | limitTo : 3}}'+
            '</div>'+
            '<div class="year">{{controller.date | luifMoment: \'YYYY\'}}</div>'+
            '</div>,',
