module Lui.Directives {
	...
	export interface ILuidUserPickerScope extends ng.IScope {
		...
		homonymsProperties: ISimpleProperty[];
		...
		onRemove: () => any;
		/** Function that filters users. For a given user, it returns if he should be kept in the set of results or not  */
		customFilter: (user: IUserLookup) => boolean;
		/** Function that will return the information to display next to each use */
