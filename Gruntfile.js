module.exports = function(grunt) {
	...
	grunt.registerTask('e2e', ["dist", "connect", "protractor:singlerun", 'concurrent:e2e']);
	...
	grunt.registerTask('travis', ["dist", "ts:test", 'karma:travis', "ts:e2e", "connect", "protractor:saucelab"]);
};
