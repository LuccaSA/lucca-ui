...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    rules: [
      ...
      {
        test: /\.ts$/,
        loaders: ['angular2-template-loader', 'awesome-typescript-loader?' + atlOptions, '@angularclass/hmr-loader'],
      ...
      {test: /\.css$/, include: root('demo', 'app'), loader: 'raw-loader!postcss-loader'},
      ...
      {test: /\.html$/, loader: 'raw-loader',  exclude: root('demo', 'public')}
    ]
  };
